	...
	<div id="info-2">
		...
		<table>
			...
			<tr>
				...
				<th>Pendidikan</th>
				<th>Pekerjaan</th>
				<th width="40px"><?php echo anchor($module.'/more_info/'.@$data->pi_no.'/2?height=400&width=320&modal=true&form=2','&nbsp;', 'class="i-add thickbox" title="Informasi Keluarga"')?></th>
			</tr>
			</thead>
			<tbody id="info2">
			<?php if ($info[0]):?>
			...
			<tr>
				...
				<td align="right">
					<?php echo anchor($module.'/more_info/'.@$data->pi_no.'/2/'.$item->pi1_idx.'?height=400&width=320&modal=true&form=2','&nbsp;', 'class="i-edit thickbox"')?>
					<?php echo anchor($module.'/more_info_delete/'.@$data->pi_no.'/2/'.$item->pi1_idx.'?height=400&width=320&modal=true&form=2','&nbsp;', 'class="i-delete"')?>
				</td>
			</tr>
			<?php endforeach?>
			<?php else:?>
	...
	<div id="info-3">
		...
		<table>
			...
			<tr>
				...
				<th>Jurusan</th>
				<th>Sertifikat</th>
				<th width="40px"><?php echo anchor($module.'/more_info/'.@$data->pi_no.'/3?height=400&width=320&modal=true&form=3','&nbsp;', 'class="i-add thickbox" title="Informasi Pendidikan Formal"')?></th>
			</tr>
			</thead>
			<tbody id="info3">
			<?php if ($info[1]):?>
			...
			<tr>
				...
				<td>
					<?php echo anchor($module.'/more_info/'.@$data->pi_no.'/3/'.$item->pi2_idx.'?height=400&width=320&modal=true&form=3','&nbsp;', 'class="i-edit thickbox"')?>
					<?php echo anchor($module.'/more_info_delete/'.@$data->pi_no.'/3/'.$item->pi2_idx.'?height=400&width=320&modal=true&form=3','&nbsp;', 'class="i-delete"')?>
				</td>
			</tr>
			<?php endforeach?>
			<?php else:?>
	...
	<div id="info-4">
		...
		<table>
			...
			<tr>
				...
				<th>Kualifikasi</th>
				<th>Tahun</th>
				<th width="40px"><?php echo anchor($module.'/more_info/'.@$data->pi_no.'/4?height=400&modal=true&width=320&form=4','&nbsp;', 'class="i-add thickbox" title="Informasi Pendidikan Informal"')?></th>
			</tr>
			</thead>
			<tbody id="info4">
			<?php if ($info[2]):?>
			...
			<tr>
				...
				<td>
					<?php echo anchor($module.'/more_info/'.@$data->pi_no.'/4/'.$item->pi3_idx.'?height=400&width=320&modal=true&form=4','&nbsp;', 'class="i-edit thickbox"')?>
					<?php echo anchor($module.'/more_info_delete/'.@$data->pi_no.'/4/'.$item->pi3_idx.'?height=400&width=320&modal=true&form=4','&nbsp;', 'class="i-delete"')?>
				</td>
			</tr>
			<?php endforeach?>
			<?php else:?>
	...
	<div id="info-5">
		...
		<table>
			...
			<tr>
				...
				<th>Nilai Membaca</th>
				<th>Nilai Menulis</th>
				<th width="40px"><?php echo anchor($module.'/more_info/'.@$data->pi_no.'/5?height=400&modal=true&width=320&form=5','&nbsp;', 'class="i-add thickbox" title="Informasi Bahasa"')?></th>
			</tr>
			</thead>
			<tbody id="info5">
			<?php if ($info[3]):?>
			...
			<tr>
				...
				<td style="text-align:center"><?php for($i=0; $i<$item->pi4_nilai_bicara; $i++) { echo "* "; } ?></td>
				...
				<td>
					<?php echo anchor($module.'/more_info/'.@$data->pi_no.'/5/'.$item->pi4_idx.'?height=400&width=320&modal=true&form=5','&nbsp;', 'class="i-edit thickbox"')?>
					<?php echo anchor($module.'/more_info_delete/'.@$data->pi_no.'/5/'.$item->pi4_idx.'?height=400&width=320&modal=true&form=5','&nbsp;', 'class="i-delete"')?>
				</td>
			</tr>
			<?php endforeach?>
			<?php else:?>
	...
	<div id="info-6">
		...
		<table>
			...
			<tr>
				...
				<th>Gaji</th>
				<th width="40px">
					<?php echo anchor($module.'/more_info/'.@$data->pi_no.'/6?height=400&width=320&modal=true&form=6','&nbsp;', 'class="i-add thickbox" title="Informasi Riwayat Pekerjaan"')?>
				</th>
			</tr>
			</thead>
			<tbody id="info6">
			...
			<tr>
				...
				<td>
					<?php echo anchor($module.'/more_info/'.@$data->pi_no.'/6/'.$item->pi5_idx.'?height=400&width=320&modal=true&form=6','&nbsp;', 'class="i-edit thickbox"')?>
					<?php echo anchor($module.'/more_info_delete/'.@$data->pi_no.'/6/'.$item->pi5_idx.'?height=400&width=320&modal=true&form=6','&nbsp;', 'class="i-delete"')?>
				</td>
			</tr>
			<?php endforeach?>
			<?php else:?>
